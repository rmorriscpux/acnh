...
# Months
Month.objects.create(name="January")
Month.objects.create(name="February")
Month.objects.create(name="March")
Month.objects.create(name="April")
Month.objects.create(name="May")
Month.objects.create(name="June")
Month.objects.create(name="July")
Month.objects.create(name="August")
Month.objects.create(name="September")
Month.objects.create(name="October")
Month.objects.create(name="November")
Month.objects.create(name="December")
